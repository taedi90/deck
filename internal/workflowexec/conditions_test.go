...
func TestEvaluateWhen_AndBindsTighterThanOr(t *testing.T) {
	...
	result, err := EvaluateWhen("runtime.a || runtime.b && runtime.c", nil, runtimeVars, nil, "E_TEST")
	if err != nil {
	...
	parenthesized, err := EvaluateWhen("(runtime.a || runtime.b) && runtime.c", nil, runtimeVars, nil, "E_TEST")
	if err != nil {
