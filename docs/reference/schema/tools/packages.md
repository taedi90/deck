...
Reference for the `Packages` family of typed workflow steps.
...
- `PackagesDownload`: Download packages into the bundle.
- `PackagesInstall`: Install package sets on the local node.

## `PackagesDownload`

Download packages into the bundle.

- schema: `../../../schemas/tools/packages.download.schema.json`
- outputs: `artifacts`
...
Install package sets on the local node.

- schema: `../../../schemas/tools/packages.install.schema.json`
