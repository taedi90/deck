...
Detailed technical documentation for deck.

- [Workspace Layout](workspace-layout.md): EnsureDirectory structure and workspace organization.
- [CLI Reference](cli.md): RunCommand-line interface usage and flags.
