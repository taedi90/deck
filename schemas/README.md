...
- `tools/kernel-module.schema.json`: `ConfigureKernelModule` (`public`)
- `tools/repository.configure.schema.json`: `ConfigureRepository` (`public`)
- `tools/swap.schema.json`: `ConfigureSwap` (`public`)
- `tools/sysctl.schema.json`: `ConfigureSysctl` (`public`)
...
- `tools/command.schema.json`: `RunCommand` (`public`)
