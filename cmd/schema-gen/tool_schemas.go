...
func toolSchemaGenerators() map[string]toolSchemaGenerator {
	return map[string]toolSchemaGenerator{
		...
		"command":                   wrapToolSchema(generateRunCommandToolSchema),
		...
		"kernel-module":             wrapToolSchema(generateConfigureKernelModuleToolSchema),
		...
		"swap":                      wrapToolSchema(generateConfigureSwapToolSchema),
		"symlink":                   wrapToolSchema(generateCreateSymlinkToolSchema),
		"sysctl":                    wrapToolSchema(generateConfigureSysctlToolSchema),
